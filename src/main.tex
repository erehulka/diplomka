...
Let $e$ and $f$ be semiedges, such that $e\neq f$. The result of the \textit{junction} of $e$ and $f$ is a new link between the other edge ends of $e$ and $f$ (incident with a vertex), and a deletion of $e$ and $f$.
