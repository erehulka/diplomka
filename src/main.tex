...
\begin{lemma}\label{le:mi-implies-distance}	
	Let $M$ be a connected nontrivial multipole. Let $m$ be the size of the minimal independent cut in $M$. Then the smallest distance between any pair of distinct semiedges in $M$ is at least $m-1$.
\end{lemma}
