...
\todo{všetky vety kde predpokladáme, že je multipól netriviálny a má nejaký minimálny nezávislý rez - čo ak nemá nezávislý rez, teda vrátane toho jedného bodu s 3 polhranami?}
...
\begin{proof}
	\todo{uprav dôkazy podľa nákresu}
	\begin{figure}
		\centering
		\begin{tikzpicture}[scale=2,every node/.style={fill=none}]
			% Define coordinates
