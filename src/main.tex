...
\todo{Túto lemu by sme mohli spraviť aj tak (alebo druhú lemu), že ak je vzdialenosť medzi ľubovoľnou dvojicou polhrán aspoň $m_i$ a $m_1+m_2\geq k$, tak obvod je aspoň $k$ alebo tak nejak.} Toto by sa dalo spraviť nejak tak, že sporný cyklus prechádza pôvodnými multipólmi, pričom ak do nejakého vojde tak z neho musí vyjsť. 
