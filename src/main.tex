...
\todo{najprv vyriešiť 1,2,3, potom pre k aspoň 4.}
...
\todo{Túto vetu treba nejak modifikovať. Lebo ak ju chceme použiť aj na tie potenciálne cyklicky k-súvislé, tak nemôžeme predpokladať že počet polhrán je práve k, treba to nejak modifikovať. Alebo vytvoriť novú pre potenciálne cyklicky k-súvislé aj s použitím prípadu kde výsledok je graf teda $|S(M)|=0$}.
